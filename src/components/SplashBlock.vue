...
<v-container>
    <v-row class="text-center">
        <v-col cols="12">
            <v-img src="https://steps.2035.university/dist/img/unti-logo.b98c487.svg" class="my-3" contain height="200" />
        </v-col>
        ...
        <v-col class="mb-4">
            ...
            <p class="subheading font-weight-regular px-8" v-if="description">
                {{description}}
            </p>
        ...
        <v-col class="mb-5" cols="12">
            <h2 class="headline font-weight-bold mb-3">
                Важные ссылки для изучения Vuetify
            </h2>
        ...
        <v-col class="mb-5" cols="12">
            <h2 class="headline font-weight-bold mb-3">
                Ссылки на проекты Университета 2035
            </h2>
...
export default {
    ...
    data: () => ({
        ecosystem: [{
                text: 'Образовательные подборки',
                href: 'https://steps.2035.university',
            },
            {
                text: 'Архипелаг',
                href: 'https://steps.2035.university/ai',
            },
            {
                text: 'Каталог',
                href: 'https://cat.2035.university/',
            },
        ],
        importantLinks: [{
                text: 'Documentation',
